...
require_once('inc/functions.common.charset.php');
...
class SearchEngineBase
{
	...
	function searchURL() {
		return "torrentsearch.php?page=torrentSearch&searchEngine=".$this->engineName;
	...
	function makeRequest($request, $useAlt = false) {
		...
		//require_once("inc/classes/SimpleHTTP.php"); // TODO fix this. Now it is included from another plugin. How do we fix this?
