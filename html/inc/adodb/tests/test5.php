...
if (0) {
	...
	$conn->debug=1;
	$conn->PConnect("hostnameOrIp","username","","xphplens");
...
if (0) {
	...
	$conn->debug=1;
	$conn->Connect("hostnameOrIp:c:\\Interbase\\Examples\\Database\\employee.gdb", "sysdba", "masterkey", ""); // connect to MySQL, testdb
	print $conn->databaseType.':'.$conn->GenID().'<br>';
}
